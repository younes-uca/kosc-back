...
@RestController
@RequestMapping("api/admin/departementTechnicien")
public class DepartementTechnicienRestAdmin {

    @Autowired
    private DepartementTechnicienAdminService departementTechnicienService;
