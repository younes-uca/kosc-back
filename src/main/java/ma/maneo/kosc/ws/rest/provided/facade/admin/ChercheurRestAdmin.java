...
import ma.maneo.kosc.service.admin.facade.ChercheurAdminService;
...
import ma.maneo.kosc.ws.rest.provided.converter.ChercheurConverter;
...
public class ChercheurRestAdmin {
    ...
    @ApiOperation("Search Chercheur by a chercheur username ")
